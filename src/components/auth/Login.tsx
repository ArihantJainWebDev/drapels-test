      ...
      <div className="w-full max-w-md bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg rounded-3xl overflow-hidden shadow-lg border border-cream-200 dark:border-gray-700">
        <div className="p-8">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-green-800 dark:text-green-300 mb-2">Welcome Back</h2>
            <p className="text-cream-700 dark:text-gray-300">Sign in to your account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-center">
              <Link href="/forgot-password" className="text-sm text-green-700 dark:text-green-300 hover:underline">
                Forgot password?
              </Link>
            </div>
          </form>
